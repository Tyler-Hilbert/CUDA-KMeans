...
Note: The faster performance of this library compared to the ArrayFire implementation is likely because ArrayFire's algorithm uses a broadcast operation on the centroids, which increases parallelism but is memory expensive, whereas my implementation avoids this by iterating over each centroid within the kernel.  